...
' * other than a list box, the Text of that control.                 *
' *                                                                  *
' *                                                                  *
' * C H A N G E   R E C O R D -------------------------------------- *
' *   DATE     PROGRAMMER     DESCRIPTION OF CHANGE		     *
' * --------   ----------     -------------------------------------- *
' * 03 04 04   Nilges         1. Added change record and issue list  *
' *                                                                  *
' *                                                                  *
' * I S S U E S ---------------------------------------------------- *
' *   DATE       POSTER       DESCRIPTION AND RESOLUTION             *
' * --------   ----------     -------------------------------------- *
' * 03 04 04   Nilges         Don't increase screen size past max    *
' *                                                                  *
' *                                                                  *
' ********************************************************************
...
Public Class zoom
    ...
    Public Overloads Sub dispose
        ...
        End With        
        _OBJwindowsUtilities = Nothing
        _OBJutilities = Nothing
