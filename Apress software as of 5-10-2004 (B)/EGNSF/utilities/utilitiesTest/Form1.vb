...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chkIncludePrivate As System.Windows.Forms.CheckBox
    Friend WithEvents cmdUtilitiesZoomDetails As System.Windows.Forms.Button
    Friend WithEvents cmdClearRegistry As System.Windows.Forms.Button
    Friend WithEvents gbxTest As System.Windows.Forms.GroupBox
    Friend WithEvents cmdTest As System.Windows.Forms.Button
    Friend WithEvents cmdTestItemParsing As System.Windows.Forms.Button
...
Me.chkIncludePrivate = New System.Windows.Forms.CheckBox
Me.cmdUtilitiesZoomDetails = New System.Windows.Forms.Button
Me.cmdClearRegistry = New System.Windows.Forms.Button
Me.gbxTest = New System.Windows.Forms.GroupBox
Me.cmdTestItemParsing = New System.Windows.Forms.Button
...
Me.lblUtilities.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
'
'lstUtilities
'
...
'cmdUtilitiesZoom
'
Me.cmdUtilitiesZoom.Location = New System.Drawing.Point(456, 8)
Me.cmdUtilitiesZoom.Name = "cmdUtilitiesZoom"
Me.cmdUtilitiesZoom.Size = New System.Drawing.Size(56, 20)
...
'cmdForm2Registry
'
Me.cmdForm2Registry.Location = New System.Drawing.Point(168, 648)
...
'cmdRegistry2Form
'
Me.cmdRegistry2Form.Location = New System.Drawing.Point(272, 648)
...
Me.nudStatusDetail.Value = New Decimal(New Integer() {3, 0, 0, 0})
'
'lblStatusDetail
'
...
'chkIncludePrivate
'
Me.chkIncludePrivate.Location = New System.Drawing.Point(8, 592)
Me.chkIncludePrivate.Name = "chkIncludePrivate"
Me.chkIncludePrivate.Size = New System.Drawing.Size(96, 48)
Me.chkIncludePrivate.TabIndex = 19
Me.chkIncludePrivate.Text = "Include Private in usage"
'
'cmdUtilitiesZoomDetails
'
Me.cmdUtilitiesZoomDetails.Location = New System.Drawing.Point(512, 8)
Me.cmdUtilitiesZoomDetails.Name = "cmdUtilitiesZoomDetails"
Me.cmdUtilitiesZoomDetails.Size = New System.Drawing.Size(112, 20)
Me.cmdUtilitiesZoomDetails.TabIndex = 20
Me.cmdUtilitiesZoomDetails.Text = "Zoom with Details"
'
'cmdClearRegistry
'
Me.cmdClearRegistry.Location = New System.Drawing.Point(376, 648)
...
'gbxTest
'
Me.gbxTest.Controls.Add(Me.cmdRandomize)
Me.gbxTest.Controls.Add(Me.cmdTestItemParsing)
Me.gbxTest.Controls.Add(Me.cmdTest)
Me.gbxTest.Location = New System.Drawing.Point(528, 520)
Me.gbxTest.Name = "gbxTest"
Me.gbxTest.Size = New System.Drawing.Size(96, 136)
Me.gbxTest.TabIndex = 24
Me.gbxTest.TabStop = False
'
'cmdTestItemParsing
'
Me.cmdTestItemParsing.Location = New System.Drawing.Point(8, 56)
Me.cmdTestItemParsing.Name = "cmdTestItemParsing"
Me.cmdTestItemParsing.Size = New System.Drawing.Size(80, 32)
Me.cmdTestItemParsing.TabIndex = 24
Me.cmdTestItemParsing.Text = "Test Item Parsing"
'
'cmdTest
'
Me.cmdTest.Location = New System.Drawing.Point(8, 16)
Me.cmdTest.Name = "cmdTest"
Me.cmdTest.Size = New System.Drawing.Size(80, 32)
Me.cmdTest.TabIndex = 19
Me.cmdTest.Text = "Test"
'
'cmdRandomize
'
Me.cmdRandomize.Location = New System.Drawing.Point(8, 96)
Me.cmdRandomize.Name = "cmdRandomize"
Me.cmdRandomize.Size = New System.Drawing.Size(80, 32)
Me.cmdRandomize.TabIndex = 26
...
Me.ControlBox = False
Me.Controls.Add(Me.gbxTest)
Me.Controls.Add(Me.cmdClearRegistry)
Me.Controls.Add(Me.cmdUtilitiesZoomDetails)
Me.Controls.Add(Me.chkIncludePrivate)
...
#Region " Form data "
    ...
    Private Shared _zoomInterface As zoomInterface
    ...
    End Enum
    ' --- Procedure scope
    Private Enum ENUprocedureScope
        publicScope
        friendScope
        privateScope
        unknownScope
    End Enum
    ' --- Procedure information
    ' Information about one overload
    Private Structure TYPoverload
        ...
        Dim colParameters As Collection     ' Parameters: no key
                                            ...
                                            '      Item(4): type
        Dim enuScope As ENUprocedureScope   ' Public, Private or Friend                                            
    End Structure
...
#Region " Form events "
    ...
    Private Sub cmdAbout_Click(ByVal sender As System.Object, _
                               ByVal e As System.EventArgs) _
                Handles cmdAbout.Click
        showAbout()
    End Sub

    Private Sub cmdClearRegistry_Click(ByVal sender As System.Object, _
                                       ByVal e As System.EventArgs) _
    ...
    Private Sub cmdForm2Registry_Click(ByVal sender As System.Object, _
                                       ByVal e As System.EventArgs) _
            Handles cmdForm2Registry.Click
        form2Registry()
    End Sub

    Private Sub cmdProcedureDump_Click(ByVal sender As System.Object, _
                                       ByVal e As System.EventArgs) _
            Handles cmdProcedureDump.Click
        MsgBox(dumpProcedures(USRutilitiesProcedures))
    End Sub

    Private Sub cmdRandomize_Click(ByVal sender As System.Object, _
                                   ByVal e As System.EventArgs) _
            Handles cmdRandomize.Click
        Randomize()
    End Sub

    Private Sub cmdRegistry2Form_Click(ByVal sender As System.Object, _
                                       ByVal e As System.EventArgs) _
            Handles cmdRegistry2Form.Click
        registry2Form()
    End Sub

    Private Sub cmdSourceLoad_Click(ByVal sender As System.Object, _
                                    ByVal e As System.EventArgs) _
                Handles cmdSourceLoad.Click
        getProcedures(sourceFileid, USRutilitiesProcedures)
    End Sub

    Private Sub cmdSourceOtherLoadFile_Click(ByVal sender As System.Object, _
                                             ByVal e As System.EventArgs) _
            Handles cmdSourceOtherFindFile.Click
        findFile()
        adjustSourceDisplay()
    End Sub

    Private Sub cmdStatusZoom_Click(ByVal sender As System.Object, _
                                    ByVal e As System.EventArgs) _
            Handles cmdStatusZoom.Click
        _zoomInterface.zoomInterface(Me, lstStatus)
    End Sub
    ...
    Private Sub cmdTestItemParsing_Click(ByVal sender As System.Object, _
                                         ByVal e As System.EventArgs) _
            Handles cmdTestItemParsing.Click
        testItemParsingInterface()
    End Sub

    Private Sub cmdUsageAnalysis_Click(ByVal sender As System.Object, _
                                       ByVal e As System.EventArgs) _
            Handles cmdUsageAnalysis.Click
        usageAnalysis(USRutilitiesProcedures)
    End Sub

    Private Sub cmdUtilitiesZoom_Click(ByVal sender As System.Object, _
                                       ByVal e As System.EventArgs) _
            Handles cmdUtilitiesZoom.Click
        _zoomInterface.zoomInterface(Me, lstUtilities)
    End Sub

    Private Sub cmdUtilitiesZoomDetails_Click(ByVal sender As System.Object, _
                                              ByVal e As System.EventArgs) _
            Handles cmdUtilitiesZoomDetails.Click
        zoomDetails()
    End Sub
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, _
        ...
        Catch objException As Exception
            MsgBox("Can't create collection utilities: " & _
    ...
    Private Sub lstUtilities_DoubleClick(ByVal sender As System.Object, _
                                         ByVal e As System.EventArgs) _
            Handles lstUtilities.DoubleClick
    ...
    Private Sub radSourceOther_Click(ByVal sender As System.Object, _
                                     ByVal e As System.EventArgs) _
            Handles radSourceOther.Click
        adjustSourceDisplay()
    End Sub

    Private Sub radSourceUtilitiesCOM_Click(ByVal sender As System.Object, _
                                            ByVal e As System.EventArgs) _
            Handles radSourceUtilitiesCOM.Click
        adjustSourceDisplay()
    End Sub

    Private Sub radSourceUtilitiesNet_Click(ByVal sender As System.Object, _
                                            ByVal e As System.EventArgs) _
            Handles radSourceUtilitiesNet.Click
        adjustSourceDisplay()
    End Sub

    Private Sub radSourceWindowsUtilitiesNet_Click(ByVal sender As System.Object, _
                                                   ByVal e As System.EventArgs) _
            Handles radSourceWindowsUtilitiesNet.Click
        adjustSourceDisplay()
    End Sub
...
#Region " General procedures "
    ...
    Private Function abstract2Oneline(ByVal strAbstract As String) As String
        ...
        For intIndex1 = 0 To UBound(strSplit)
            ...
            For intIndex2 = 1 To Len(strSplit(intIndex1))
                ...
                End If
            Next intIndex2
            If intCount >= Len(strSplit(intIndex1)) * 0.75 Then
    ...
    ' -----------------------------------------------------------------
    ' Return True (procedure includes at least one Public overload)
    ' or False
    '
    '
    Private Function anyPublic(ByVal usrProcedure As TYPprocedure) As Boolean
        With usrProcedure
            Dim intIndex1 As Integer
            For intIndex1 = 1 To UBound(.usrOverload)
                If .usrOverload(intIndex1).enuScope = ENUprocedureScope.publicScope Then
                    Return (True)
                End If
            Next intIndex1
            Return (False)
    ...
    ' -----------------------------------------------------------------
    ' Clear Registry settings: restore default values
    '
    '
    Private Function clearRegistry() As Boolean
        If Not _OBJwindowsUtilities.clearRegistryKey(Application.ProductName) Then
            Return (False)
        End If
        registry2Form()
    End Function
    ...
    Private Sub destroyProcInfo(ByRef usrProcedureInfo As TYPindexedProcedures)
        With usrProcedureInfo
            ...
            OBJcollectionUtilities.collectionClear(.colIndex) : .colIndex = Nothing
            Dim intIndex1 As Integer
            Dim intIndex2 As Integer
    ...
    Private Sub displayInfoForm(ByVal strUtility As String, _
        ...
        Catch ex As Exception
            ...
            Return
        End Try
        _zoomInterface.zoomInterface(Me, _
                                     procedure2Info(usrIndexedProcedures, _
                                     intIndex1), dblHeight:=1)
    End Sub
    ...
    Private Function displayInfoForm_usageAnalysis _
            (ByVal usrIndexedProcedures As TYPindexedProcedures, _
            ...
            ElseIf (Not .colUsedBy Is Nothing) AndAlso (Not .colUses Is Nothing) Then
                ...
                With .colUsedBy
                    For intIndex1 = 1 To .Count
                        strName = CStr(.Item(intIndex1))
                        intIndex2 = CInt(usrIndexedProcedures.colIndex(strName))
                        If intIndex2 <> 0 _
                           AndAlso _
                           (chkIncludePrivate.Checked _
                            OrElse _
                            anyPublic(usrIndexedProcedures.usrProcedures(intIndex2))) Then
                            _OBJutilities.append(strUsed, ", ", strName)
                        End If
                    Next intIndex1
                End With
                    ...
                    For intIndex1 = 1 To .Count
                        ...
                        If intIndex2 <> 0 _
                           ...
                           (chkIncludePrivate.Checked _
                            OrElse _
                            anyPublic(usrIndexedProcedures.usrProcedures(intIndex2))) Then
                            _OBJutilities.append(strUses, ", ", strName)
                        End If
                    Next intIndex1
                End With
                strUsageAnalysis &= _
    ...
    Private Function dumpProcedures(ByVal usrIndexedProcedures As TYPindexedProcedures) _
        ...
        If procInfoExists(usrIndexedProcedures) Then
            With usrIndexedProcedures
                strOutstring = "Index: " & OBJcollectionUtilities.collection2String(.colIndex) & _
                ...
                For intIndex1 = 1 To UBound(.usrProcedures)
                    With .usrProcedures(intIndex1)
                        _OBJutilities.append(strOutstring, _
                                             ...
                                             "Uses: " & OBJcollectionUtilities.collection2String(.colUses) & vbNewLine & _
                                             "Used by: " & OBJcollectionUtilities.collection2String(.colUsedBy))
                    End With
                Next intIndex1
            End With
        End If
        ...
        With usrIndexedProcedures
            ...
            With .usrProcedures(intIndex1)
                ...
                Catch ex As Exception
                    ...
                    Return (False)
                End Try
                Dim enuScope As ENUprocedureScope = _
                    scopeString2Enum_(_OBJutilities.item(.strText, _
                                                         1, _
                                                         _OBJutilities.range2String(0, 32), True))
                If enuScope = ENUprocedureScope.unknownScope Then
                    errorHandler("The " & strName & " procedure has unknown scope", _
                                 "getProcedures_file2Procedures", _
                                 "Public scope assumed")
                    enuScope = ENUprocedureScope.publicScope
                End If
    ...
    Private Function getProcedures_findProbableStart(ByVal strInfile As String, _
        ...
        Dim intIndex1 As Integer = nzMin(InStr(intIndex, strInfile, vbNewLine & "    Public"), _
                                         InStr(intIndex, strInfile, vbNewLine & "    Friend"), _
                                         InStr(intIndex, strInfile, vbNewLine & "    Private"))
        If intIndex1 = 0 Then Return (Len(strInfile) + 1)
        Dim intIndex2 As Integer
        intIndex2 = InStrRev(strInfile, vbNewLine & "    ' ----------", intIndex1)
        ...
        With lstBox
            ...
            For intIndex1 = 1 To UBound(usrProcedureTable)
                With usrProcedureTable(intIndex1)
                    For intIndex2 = 1 To UBound(.usrOverload)
                        If .usrOverload(intIndex2).enuScope = ENUprocedureScope.publicScope Then
                            Exit For
                        End If
                    Next intIndex2
                    If intIndex2 <= UBound(.usrOverload) Then
    ...
    ' -----------------------------------------------------------------
    ' Return the smallest nonzero value
    '
    '
    Private Function nzMin(ByVal ParamArray intValues() As Integer) As Integer
        Dim intIndex1 As Integer
        Dim intMin As Integer
        For intIndex1 = 0 To UBound(intValues)
            If intValues(intIndex1) <> 0 Then
                If intMin = 0 Then
                    intMin = intValues(intIndex1)
                Else
                    intMin = Math.Min(intMin, intValues(intIndex1))
                End If
            End If
        Next intIndex1
        Return (intMin)
    ...
    ' -----------------------------------------------------------------
    ' Formats the procedure information
    '
    '
    Private Function procedure2Info(ByVal usrIndexedProcedures As TYPindexedProcedures, _
                                    ByVal intIndex As Integer) As String
        Return (usrIndexedProcedures.usrProcedures(intIndex).strAbstract & _
                            vbNewLine & vbNewLine & _
                            displayInfoForm_usageAnalysis _
                            (usrIndexedProcedures, _
                             usrIndexedProcedures.usrProcedures(intIndex)) & _
                            vbNewLine & vbNewLine & _
                            "S O U R C E   C O D E" & _
                            vbNewLine & vbNewLine & _
                            usrIndexedProcedures.usrProcedures(intIndex).strText)
    End Function
    ...
    ' -----------------------------------------------------------------
    ' Converts the scope name to its enumerator
    '
    '
    Private Function scopeString2Enum_(ByVal strScope As String) As ENUprocedureScope
        Select Case UCase(Trim(strScope))
            Case "PUBLIC" : Return (ENUprocedureScope.publicScope)
            Case "PRIVATE" : Return (ENUprocedureScope.privateScope)
            Case "FRIEND" : Return (ENUprocedureScope.friendScope)
            Case Else : Return (ENUprocedureScope.unknownScope)
        End Select
    End Function
    ...
    Private Sub showAbout()
        MsgBox(ABOUTINFO & vbNewLine & vbNewLine & _
               "Version: " & Application.ProductVersion & _
               vbNewLine & vbNewLine & vbNewLine & _
               "About the utilities class: " & vbNewLine & vbNewLine & _
               _OBJutilities.item(_OBJutilities.About, _
                                  1, _
                                  vbNewLine & vbNewLine, _
                                  False))
    End Sub
    ...
    Private Sub testInterface()
        ...
        If radSourceUtilitiesNet.Checked Then
            ...
            If booOK Then
                booOK = _OBJutilities.itemTest(strReport2)
                strReport &= vbNewLine & vbNewLine & vbNewLine & _
                             "ITEM TESTING" & _
                             vbNewLine & vbNewLine & _
                             strReport2
            End If
        ...
        _zoomInterface.zoomInterface(Me, strReport, dblHeight:=1)
    End Sub
    ...
    '
    '
    Private Sub testItemParsingInterface()
        Dim frmTest As testItemParsing
        Try
            frmTest = New testItemParsing
        Catch
            errorHandler("Can't create test form: " & _
                         Err.Number & " " & Err.Description, _
                         "testItemParsingInterface", _
                         "")
            Return
        End Try
        frmTest.ShowDialog()
    ...
    ' -----------------------------------------------------------------
    ' Zoom details about all procedures
    '
    '
    Private Sub zoomDetails()
        Dim strActivity As String = "Creating details"
        updateStatusListBox(1, strActivity)
        Dim objStringBuilder As System.Text.StringBuilder
        Try
            objStringBuilder = New System.Text.StringBuilder
        Catch ex As Exception
            errorHandler("Can't create string builder: " & Err.Number & " " & Err.Description, _
                         "zoomDetails", _
                         "Cannot show procedure details")
            Return
        End Try
        Dim intIndex1 As Integer
        For intIndex1 = 1 To UBound(USRutilitiesProcedures.usrProcedures)
            updateProgress(lblProgress, _
                           strActivity, _
                           "procedure", _
                           intIndex1, _
                           UBound(USRutilitiesProcedures.usrProcedures))
            If anyPublic(USRutilitiesProcedures.usrProcedures(intIndex1)) Then
                If Not _OBJutilities.append(objStringBuilder, _
                                            vbNewLine & vbNewLine & vbNewLine & vbNewLine, _
                                            procedure2Info(USRutilitiesProcedures, intIndex1)) Then
                    Exit For
                End If
            End If
        Next intIndex1
        lblProgress.Visible = False
        updateStatusListBox(-1, "Details created")
        _zoomInterface.zoomInterface(Me, objStringBuilder.ToString)
    End Sub
