...
Me.cmdClose.Location = New System.Drawing.Point(528, 616)
Me.cmdClose.Name = "cmdClose"
Me.cmdClose.Size = New System.Drawing.Size(96, 56)
...
'cmdForm2Registry
'
Me.cmdForm2Registry.Location = New System.Drawing.Point(320, 648)
...
'cmdRegistry2Form
'
Me.cmdRegistry2Form.Location = New System.Drawing.Point(424, 648)
...
'cmdTest
'
Me.cmdTest.Location = New System.Drawing.Point(8, 648)
...
#Region " Form events "
    ...
    Private Sub cmdUtilitiesZoomDetails_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdUtilitiesZoomDetails.Click
        zoomDetails 
    End Sub
...
#Region " General procedures "
    ...
    Private Sub displayInfoForm(ByVal strUtility As String, _
        ...
        Catch ex As Exception
            ...
            Return                         
        End Try     
        zoomInterface(procedure2Info(usrIndexedProcedures, intIndex1), dblHeight:=1)
    End Sub    
    ...
    '
    '
    Private Function nzMin(ParamArray intValues() As Integer) As Integer
        Dim intIndex1 As Integer
    ...
    Private Sub zoomDetails
        ...
        zoomInterface(objStringBuilder.ToString)          
    End Sub      
